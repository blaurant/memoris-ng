...
Le Producteur s'engage a :
- Maintenir ses installations de production en bon etat de fonctionnement
- Respecter les normes de securite et reglementations en vigueur
- Declarer toute modification de ses installations de production
- Fournir les informations exactes relatives a son point de livraison (PDL/PRM)
...
- Garantir la transparence des tarifs et des clefs de repartition

Article 4 - Duree
Le present contrat est conclu pour une duree initiale de 12 mois,
renouvelable par tacite reconduction.

Article 5 - Resiliation
Chaque partie peut resilier le contrat avec un preavis de 60 jours.
La resiliation n'affecte pas les compensations dues pour la production
deja injectee.

Article 6 - Protection des donnees
Les donnees personnelles sont traitees conformement au RGPD.
Le Producteur dispose d'un droit d'acces, de rectification
et de suppression de ses donnees.")
